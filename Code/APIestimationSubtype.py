...
disorder = "sdb" # "n" for healthy subjects or specify the examined disorder: "sdb" for healthy and SDB, "ins" for healthy and insomnia, "nfle" for healthy and NFLE
if useSDpatients == 1:
...
def PlotSubject (ee,ff,AphaseIndex,AphaseInde30s,AphaseInde60s,
    ...
    if UseAPhaseEnsable == 1:
        if useSDpatients == 1:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_NearRealTime_Subejct_"+addText+"_{}_Epoch{}.png".format(ee, ff))
        else:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_NearRealTime_Subejct_"+addText+"_{}_Epoch{}-notSD.png".format(ee, ff))
    else:
        if useSDpatients == 1:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_NearRealTime_Center_Subejct_"+addText+"_{}_Epoch{}.png".format(ee, ff))
        else:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_NearRealTime_Center_Subejct_"+addText+"_{}_Epoch{}-notSD.png".format(ee, ff))
    plt.close()
    # plt.show()
    ...
    if UseAPhaseEnsable == 1:
        if useSDpatients == 1:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated30s_Subejct_"+addText+"_{}_Epoch{}.png".format(ee, ff))
        else:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated30s_Subejct_"+addText+"_{}_Epoch{}-notSD.png".format(ee, ff))
    else:
        if useSDpatients == 1:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated30s_Center_Subejct_"+addText+"_{}_Epoch{}.png".format(ee, ff))
        else:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated30s_Center_Subejct_"+addText+"_{}_Epoch{}-notSD.png".format(ee, ff))
    # plt.show()
    ...
    if UseAPhaseEnsable == 1:
        if useSDpatients == 1:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated60s_Subejct_"+addText+"_{}_Epoch{}.png".format(ee, ff))
        else:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated60s_Subejct_"+addText+"_{}_Epoch{}-notSD.png".format(ee, ff))
    else:
        if useSDpatients == 1:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated60s_Center_Subejct_"+addText+"_{}_Epoch{}.png".format(ee, ff))
        else:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated60s_Center_Subejct_"+addText+"_{}_Epoch{}-notSD.png".format(ee, ff))
    # plt.show()
    ...
    if UseAPhaseEnsable == 1:
        if useSDpatients == 1:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated30m_Subejct_"+addText+"_{}_Epoch{}.png".format(ee, ff))
        else:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated30m_Subejct_"+addText+"_{}_Epoch{}-notSD.png".format(ee, ff))
    else:
        if useSDpatients == 1:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated30m_Center_Subejct_"+addText+"_{}_Epoch{}.png".format(ee, ff))
        else:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated30m_Center_Subejct_"+addText+"_{}_Epoch{}-notSD.png".format(ee, ff))
    # plt.show()
    ...
    if UseAPhaseEnsable == 1:
        if useSDpatients == 1:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated60m_Subejct_"+addText+"_{}_Epoch{}.png".format(ee, ff))
        else:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated60m_Subejct_"+addText+"_{}_Epoch{}-notSD.png".format(ee, ff))
    else:
        if useSDpatients == 1:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated60m_Center_Subejct_"+addText+"_{}_Epoch{}.png".format(ee, ff))
        else:
            plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Accumulated60m_Center_Subejct_"+addText+"_{}_Epoch{}-notSD.png".format(ee, ff))
    # plt.show()
    plt.close()
...
def plotRegression (API_MetricsAverages,API_MetricsAveragesDatabase,PolinomialOrder):
    ...
    plt.show()
    # if useSDpatients == 1:
    #     plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Regression_API_NearRealTime.png")
    # else:
    #     plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Regression_API_NearRealTime-notSD.png")
    # plt.close()
    # plt.ioff()
    # plt.figure()
    ...
    plt.show()
    # if useSDpatients == 1:
    #     plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Regression_API_30s.png")
    # else:
    #     plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Regression_API_30s-notSD.png")
    # plt.close()
    # plt.ioff()
    # plt.figure()
    ...
    plt.show()
    # if useSDpatients == 1:
    #     plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Regression_API_60s.png")
    # else:
    #     plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Regression_API_60s-notSD.png")
    # plt.close()
    # plt.ioff()
    # plt.figure()
    ...
    plt.show()
    # if useSDpatients == 1:
    #     plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Regression_API_30m.png")
    # else:
    ...
    plt.show()
    # if useSDpatients == 1:
    #     plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Regression_API_60m.png")
    # else:
    #     plt.savefig(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_Regression_API_60m-notSD.png")
    # plt.close()
...
for ee in range (startEpochs, Epochs, 1): # number of the subject to be examined
    ...
    if UseAPhaseEnsable == 1:
        if useSDpatients == 1:
            StringTextA = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_EstimatedAPhase_PostProcessing_subject{}_Epoch{}_KernelSize{}.txt".format(ee, ff, KernelSize) 
            StringTextN = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_EstimatedNREM_PostProcessing_subject{}_Epoch{}_KernelSize{}.txt".format(ee, ff, KernelSize) 
        else:
            StringTextA = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_EstimatedAPhase_PostProcessing_subject{}_Epoch{}-notSDB_KernelSize{}.txt".format(ee, ff, KernelSize) 
            StringTextN = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_EstimatedNREM_PostProcessing_subject{}_Epoch{}-notSDB_KernelSize{}.txt".format(ee, ff, KernelSize) 
    else:
        if useSDpatients == 1:
            StringTextA = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_EstimatedAPhaseAfterCorrection_Center_Center_subject{}_Epoch{}_KernelSize{}.txt".format(ee, ff, KernelSize) 
            StringTextN = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_EstimatedNREMAfterCorrection_Center_Center_subject{}_Epoch{}_KernelSize{}.txt".format(ee, ff, KernelSize) 
        else:
            StringTextA = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_EstimatedAPhaseAfterCorrection_Center_Center_subject{}_Epoch{}-notSDB_KernelSize{}.txt".format(ee, ff, KernelSize) 
            StringTextN = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_EstimatedNREMAfterCorrection_Center_Center_subject{}_Epoch{}-notSDB_KernelSize{}.txt".format(ee, ff, KernelSize) 
    ...
    if UseAPhaseEnsable == 1:
        if useSDpatients == 1:
            StringTextA = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_DatabaseAPhase_Combined_subject{}_Epoch{}_KernelSize{}.txt".format(ee, ff, KernelSize) 
            StringTextN = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_DatabaseNREM_Combined_subject{}_Epoch{}_KernelSize{}.txt".format(ee, ff, KernelSize) 
        else:
            StringTextA = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_DatabaseAPhase_Combined_subject{}_Epoch{}-notSDB_KernelSize{}.txt".format(ee, ff, KernelSize) 
            StringTextN = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_DatabaseNREM_Combined_subject{}_Epoch{}-notSDB_KernelSize{}.txt".format(ee, ff, KernelSize) 
    else:
        if useSDpatients == 1:
            StringTextA = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_DatabaseAPhaseAfterCorrection_Center_Center_subject{}_Epoch{}_KernelSize{}.txt".format(ee, ff, KernelSize) 
            StringTextN = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_DatabaseNREMAfterCorrection_Center_Center_subject{}_Epoch{}_KernelSize{}.txt".format(ee, ff, KernelSize) 
        else:
            StringTextA = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_DatabaseAPhaseAfterCorrection_Center_Center_subject{}_Epoch{}-notSDB_KernelSize{}.txt".format(ee, ff, KernelSize) 
            StringTextN = str (disorder) + "_subtype_" + str(APhaseSubtype)+"_DatabaseNREMAfterCorrection_Center_Center_subject{}_Epoch{}-notSDB_KernelSize{}.txt".format(ee, ff, KernelSize) 
...
for ee in range (startEpochs, Epochs, 1): # number of the subject to be examined
    ...
    if saveAPIMetrics == 1:
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseIndex.txt", 'ab')
        pickle.dump(AphaseIndex, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseIndexd.txt", 'ab')
        pickle.dump(AphaseIndexd, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30s.txt", 'ab')
        pickle.dump(AphaseInde30s, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30sd.txt", 'ab')
        pickle.dump(AphaseInde30sd, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60s.txt", 'ab')
        pickle.dump(AphaseInde60s, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60sd.txt", 'ab')
        pickle.dump(AphaseInde60sd, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30m.txt", 'ab')
        pickle.dump(AphaseInde30m, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30md.txt", 'ab')
        pickle.dump(AphaseInde30md, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60m.txt", 'ab')
        pickle.dump(AphaseInde60m, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60md.txt", 'ab')
        pickle.dump(AphaseInde60md, f)
        f.close()
    
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseIndexBLplot.txt", 'ab')
        pickle.dump(AphaseIndexCorrected, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseIndexdBLplot.txt", 'ab')
        pickle.dump(np.mean(AphaseIndexd), f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30sBLplot.txt", 'ab')
        pickle.dump(AphaseInde30sCorrected, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30sdBLplot.txt", 'ab')
        pickle.dump(np.mean(AphaseInde30sd), f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60sBLplot.txt", 'ab')
        pickle.dump(AphaseInde60sCorrected, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60sdBLplot.txt", 'ab')
        pickle.dump(np.mean(AphaseInde60sd), f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30mBLplot.txt", 'ab')
        pickle.dump(AphaseInde30mCorrected, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30mdBLplot.txt", 'ab')
        pickle.dump(np.mean(AphaseInde30md), f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60mBLplot.txt", 'ab')
        pickle.dump(AphaseInde60mCorrected, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60mdBLplot.txt", 'ab')
        pickle.dump(np.mean(AphaseInde60md), f)
        f.close()
        
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseIndexBLplotSD.txt", 'ab')
        pickle.dump(AphaseIndexCorrected, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseIndexdBLplotSD.txt", 'ab')
        pickle.dump(np.mean(AphaseIndexd), f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30sBLplotSD.txt", 'ab')
        pickle.dump(AphaseInde30sCorrected, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30sdBLplotSD.txt", 'ab')
        pickle.dump(np.mean(AphaseInde30sd), f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60sBLplotSD.txt", 'ab')
        pickle.dump(AphaseInde60sCorrected, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60sdBLplotSD.txt", 'ab')
        pickle.dump(np.mean(AphaseInde60sd), f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30mBLplotSD.txt", 'ab')
        pickle.dump(AphaseInde30mCorrected, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30mdBLplotSD.txt", 'ab')
        pickle.dump(np.mean(AphaseInde30md), f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60mBLplotSD.txt", 'ab')
        pickle.dump(AphaseInde60mCorrected, f)
        f.close()
        f = open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60mdBLplotSD.txt", 'ab')
        pickle.dump(np.mean(AphaseInde60md), f)
        f.close()
