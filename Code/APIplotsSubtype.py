...
PlotErrorBars=0 # 1 to plot the errorbars
...
objectNRT = []
with (open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseIndex.txt", "rb")) as openfile:
    while True:
        try:
            ...
            break
objectNRTd = []
with (open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseIndexd.txt", "rb")) as openfile:
    while True:
        try:
            ...
            break
object30s = []
with (open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30s.txt", "rb")) as openfile:
    while True:
        try:
            ...
            break
object30sd = []
with (open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30sd.txt", "rb")) as openfile:
    while True:
        try:
            ...
            break
object60s = []
with (open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60s.txt", "rb")) as openfile:
    while True:
        try:
            ...
            break
object60sd = []
with (open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60sd.txt", "rb")) as openfile:
    while True:
        try:
            ...
            break
object30m = []
with (open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30m.txt", "rb")) as openfile:
    while True:
        try:
            ...
            break
object30md = []
with (open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde30md.txt", "rb")) as openfile:
    while True:
        try:
            ...
            break
object60m = []
with (open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60m.txt", "rb")) as openfile:
    while True:
        try:
            ...
            break
object60md = []
with (open(str (disorder) + "_subtype_" + str(APhaseSubtype)+"_AphaseInde60md.txt", "rb")) as openfile:
    while True:
        try:
